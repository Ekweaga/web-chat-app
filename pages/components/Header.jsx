    ...
    <header className='flex justify-center items-center '>
        ...
        <div className='w-[600px] mt-[30px]'>
          <div className="bg-[#E8F1FE] w-[230px] p-2 text-sm text-[#84B6F9] rounded-2xl mb-[15px]">Connectron community</div>
            <h1 className='text-[#0A093D] text-5xl font-bold mb-[20px]'>Your Solutions For <br/> Community!</h1>
            <p className="w-[450px] text-sm">More than 1 million people in over countries use connectron to stay in touch with friends and family</p>
